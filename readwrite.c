...
int Save_file_technician(FILE* fp, technicianslink head)
{
	...
	{
		fprintf(fp, "%d %s %d %d %.2f %.2f %.2f %.2f %.2f %.2f\n ", temp_node->count, temp_node->name, \
			temp_node->sex, temp_node->age, temp_node->height, temp_node->weight, temp_node->breast, \
			temp_node->waist, temp_node->hips, temp_node->monthly_salary);
	}
